...
public class EntryUserRegistration {
	...
	public void isValidPasswordAccToRule2() {
		Scanner sc = new Scanner(System.in);
	...
	public void isValidPasswordAccToRule3() {
		Scanner sc = new Scanner(System.in);
		System.out.print("Enter min 8 char password should contain one uppercase and one numeric Value: ");
		String password = sc.nextLine();
	...
	// Method for Validate all sample email
	public void isValidSampleEmail() {
		Scanner sc = new Scanner(System.in);
